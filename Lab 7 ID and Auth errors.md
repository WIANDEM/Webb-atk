...
Для поиска скрытых файлов и директорий на сайте `https://duck-store.escape.tech` был использован инструмент **ffuf**. Использовал словари, содержащие наиболее вероятные пути, характерные для приложений на этом фреймворке. 
